                                            ...
                                            <div key={i}>
                                                <div className="card facebook-card" >
                                                    <div className="card-header no-border">
                                                        ...
                                                        <div className="facebook-name" style={{ textAlign: "left" }}>{v.rcmdInfo.userReason}</div>
                                                    </div>
                                                    <div className="card-content" onClick={() => {
                                                        ...
                                                        {v.pics.map((v, i) => {
                                                            return <div key={i} style={{backgroundImage: 'url('+v.originUrl+')', float: "left", width: "103px", height: "103px" }}><img src={v.originUrl} width="100px" height="100px" /></div>
                                                        })}
                                                    </div>
                                                    <div className="card-footer no-border">
                                                        ...
                                                        <a href="#" className="link">评论{v.info.commentCount}</a>
                                                        <a href="#" className="link">分享{v.info.shareCount}</a>
                                                    </div>
